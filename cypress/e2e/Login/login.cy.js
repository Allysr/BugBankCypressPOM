...
describe("Página de Login", () => {
  ...
  context("C03 - Validar campos vazios.", () => {
    it("Campo e-mail vazio", () => {
      ...
      expect(
        cy
          .get(elemento.mensagemCampoObrigatorio)
          .should("be.visible")
  ...
  it("C06 - Validar visualização de senha oculta.", () => {
    ...
    expect(
      cy
        .get(elemento.textoSenhaVisivel)
        .should("be.visible")
  ...
  it("C07 - Validar ocultar senha.", () => {
    login.preencherSenha(Cypress.env("senha"));
    expect(cy.get(elemento.textoSenhaEscondido).should("be.visible"));
  });
});
